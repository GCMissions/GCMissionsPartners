			...
			initEvents : function(){
					...
					columns: [{
						...
						formatter: function(value,row,index){
							return "<div class='adspic-list'><ul><li class='adspic-upload'><div class='upload-thumb'>" +
								   "<img src='" + value + "' class='resourceImage'>" +
								   "</div></li></ul></div>";
						}
					} , {
						field: 'link',
						...
						formatter: function(value,row,index){
							var result = "";
							result += "<a href='" + urlPrefix + "resource/view/" + value + "' class='detailItem' data-id='"+value+"'>Edit</a>";
				...
				$("#dataList").on('click','.deleteItem',function(){
					...
					this.dialog =  BootstrapDialog.show({
		                ...
		                message: 'Confirm to delete the resource?',
		                draggable: true,
