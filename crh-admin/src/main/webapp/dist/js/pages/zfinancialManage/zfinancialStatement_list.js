	...
	var financial = {
		...
		initTable1 : function() {
			...
			$.GLOBAL.utils.loadBootTable({
	            ...
	            pagination : true,
	            pageSize : 10,
	            url: "zfinancialStatement/findAll",
	            ...
	            columns: [
	             ...
	             onLoadSuccess:function(data){
	            	 if(data){
	            		 ...
	            		 $("#zTotalProProfit").html(_self.formatPrice(data.zTotalProProfit)+"元");
	            		 $("#zTotalShipProfit").html(_self.formatPrice(data.zTotalShipProfit)+"元");
