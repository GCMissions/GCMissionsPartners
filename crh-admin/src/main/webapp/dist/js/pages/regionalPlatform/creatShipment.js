	...
	var creatShipment = {
			...
			init :function(){
			    ...
			    $("#chooseOrg").bsSuggest({
			        ...
			        //type:"POST",
			        url: urlPrefix + "pshipment/matchingOrg", /*优先从url ajax 请求 json 帮助数据，注意最后一个参数为关键字请求参数*/
			        fnAdjustAjaxParam: function(keyword, opts){
			        	var type=$("#orgCate").val();
			        	return {
			        		 type: 'POST',
			                 url: urlPrefix + "pshipment/matchingOrg",
			                 dataType: 'json',
			                 //dataType: 'jsonp',
			                 timeout: 5000,
			...
			bindEvents : function(){
				...
				$('#back').on("click", function() {
					window.location.href = urlPrefix + "pshipment/";
				});
