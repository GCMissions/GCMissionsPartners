 ...
 * Date: 14-04-08
 * Time: 16:34 Pm
 * Upload the picture dialog box logic code, including tab: remote picture / upload picture / online picture / search picture
 */
...
(function () {
        ...
        dialog.onok = function () {
            ...
            switch (id) {
                ...
                case 'upload':
                    ...
                    if (count) {
                        $('.info', '#queueList').html('<span style="color:red;">' + 'There are 2 files that have not been uploaded'.replace(/[\d]/, count) + '</span>');
                        return false;
                    }
                    break;
                case 'online':
    ...
    /* Click event that initializes the way it is initialized */
    function initAlign(){
        /* click align icon */
    ...
    RemoteImage.prototype = {
        ...
        setImage: function(img){
            ...
            /* Preventing onchange events from looping calls*/
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // When a file is added, execute, responsible for the creation of view
    ...
    OnlineImage.prototype = {
        ...
        /* Initialize the scroll event and scroll to the point where the data is automatically pulled */
        initEvents: function () {
            var _this = this;
        ...
        initData: function () {
            ...
            /* Pulls the value that data needs to be used */
            this.state = 0;
        ...
        /* Draws the picture list data from the background */
        ...
        /* Add pictures to list interface */
