      	...
      	<div class="content-wrapper page-content-wrapper">
       		<section class="content-header">    
        		...
        		<ol class="breadcrumb">
		            ...
		            <li><i class="fa"></i> 发货管理</li>
		            <li><i class="fa"></i> 发货</li>
		            <li><i class="fa"></i> 发货详情</li> 
      		 	</ol>
      		 	<#elseif status ==2 || status ==4>
      		 	<ol class="breadcrumb">
		            <li><i class="fa fa-dashboard"></i> 库存管理</li>
		            <li><i class="fa"></i> 收货管理</li>
		            <li><i class="fa"></i> 扫码收货</li>
       					...
       					<div class="col-md-12">
       						<div class="box-body">
		       					...
		       					<div class="tab-content col-md-6" id="info">
		       						<div>
		       							...
		       							<tbody id="product_list">
					       					...
					       					<tr data-id=${list.goodId}>
					       						<td id="name_${list.goodId}">${list.goodName}</td>
					       			...
					       			<#if status== 1 || status == 3 || status == 5>
			       					<a class="btn btn-primary" id="save1">确认发货</a>
			       					<#elseif status == 2 || status ==4>
			       					<a class="btn btn-primary" id="save2">确认收货</a>
			       					</#if>
			       				</div>
		       						<#list orderDetail.data.goodDtos as list>
		       						<div>
