				...
				<div class="col-md-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs" id="mytabs" >
							<#if charityDto?? && charityDto.status == '4'>
								<li class="active"><a href="#tab_3" data-toggle="tab">公益活动反馈详情</a></li>
							<#else>
						...
						<#else>
							<div class="tab-pane active" id="tab_1">
								...
								<div class="box-body">
									<form id="mainForm" role="form" class="form-horizontal" charity-id="${(charityDto.id)!}" oper="edit">
										<div class="form-group">
											<label class="col-sm-2 control-label"><span class="requiredField">*</span>公益活动名称：</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="charityName" name="charityName" maxlength="50" placeholder="公益活动名称" value="${(charityDto.name)!}"/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label"><span class="requiredField">*</span>公益活动说明：</label>
											<div class="col-sm-7">
												<textarea rows=3 cols=220 class="form-control" id="explainNote" name="explainNote" maxlength="100" placeholder="公益活动说明">${(charityDto.explainNote)!}</textarea>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-9 date-area">
												<div class="form-horizontal">
													<div class="dateDiv" style="margin-bottom: 0px;">
														<input size="20" type="text" id="startDate" class="form-control keyword" placeholder="活动开始时间" value="${(charityDto.startTime)!}" readonly> 
														<span class="add-on" style="display: none"><i class="icon-remove"></i></span> 
														<span class="add-on"><i class="icon-calendar"></i></span>
													</div>
												
													<div class="dateDiv" style="margin-bottom: 0px;">
														<input size="20" type="text" id="endDate" class="form-control keyword" placeholder="活动结束时间" value="${(charityDto.endTime)!}" readonly> 
														<span class="add-on" style="display: none"><i class="icon-remove"></i></span> 
														<span class="add-on"><i class="icon-calendar"></i></span>
													</div>
												</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<script id="ueEditor-platform" name="detailDesc" type="text/plain" style="width:100%;height:500px;">
							...
							<div class="tab-pane" id="tab_3">
								...
								<div class="box-body">
									<form id="feedbackForm" role="form" class="form-horizontal" method=post>
										<div class="form-group">
											<div class="col-sm-12">
												<script id="ueEditor" name="detailFeedback" type="text/plain" style="width:100%;height:500px;">
												${(charityDto.feedback)!}
												</script>
											</div>
										</div>
										<div style="text-align: center">
										    <button class="btn btn-primary" type="button" id="saveFeedback">保存</button>
											<button class="btn btn-success back-away" type="button">
												<i class="fa fa-backward"> 返回 </i>
											</button>
										</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="select-feature" style="margin-left:120px;">
