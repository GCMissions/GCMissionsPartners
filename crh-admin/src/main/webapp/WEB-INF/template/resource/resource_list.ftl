             ...
             <div class="col-md-12">
                <div class="box box-primary">
                    <div class="form-horizontal search-group" id="search-area" >
                    	<div class="box-body">
                    		<div class="col-sm-12">
                    			<a class="btn btn-default" href="${urlPrefix}resource/view/0"><i class="fa fa-plus"></i> Add</a>     
                    		</div>
                    	</div>
                    </div>
                    <div class="box-body">
...
<script type="text/javascript" src="${uiBase}js/pages/resource/resource_list.js?v=${resourceVersion}"></script>