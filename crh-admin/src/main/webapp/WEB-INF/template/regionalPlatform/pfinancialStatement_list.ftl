				...
				<div class="col-md-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#tab_1" data-toggle="tab" data-index="0">财务报表</a></li>
								...
								<div class="form-horizontal search-group" id="search-area">
									<div class="box-body">
										<form id="orderForm1" method="get"
											action="${base}/web/pfinancialStatement/export">
								...
								<div class="box-body">
									<table id="dataList1" class="table table-bordered table-hover">
										<caption>
											...
											配送费总分利：<span id="pTotalShipProfit"></span>
								                                    商品总分利：<span id="pTotalProProfit"></span>
								                                    合计分利：<span id="pTotalSPProfit"></span>
										</caption>
										<thead>
											<th>序号</th>
											<th>订单编号</th>
...
<script type="text/javascript"
	src="${uiBase}js/pages/regionalPlatform/pfinancialStatement_list.js?v=${resourceVersion}"></script>
</html>
