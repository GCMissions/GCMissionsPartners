             ...
             <div class="col-md-12">                    						 
				 <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="freightIndex">终端配送商配送费</a>
                        </li>
                        <li class=""><a href="freeIndex">商品免运费设置</a>
                        </li>
                    </ul>
                    <form id="freightConfigForm" method="post" action="">                                          
                        ...
                        <div class="row">
	                        <div class="col-md-12">
		                        <div class="col-md-12">
		                        	...
		                        	<input type="text" class="form-control defaultStartNum default_input hidden" name="defaultStartNum" value="1">
		                        	<label class="control-label" for="type-select">1瓶内,</label>		                        
		                        	...
		                        	<label class="control-label" for="type-select">2瓶及以上</label>
		                        	<input type="text" class="form-control defaultPlusNum default_input hidden" name="defaultPlusNum" value="1">
		                        	<label class="control-label" for="type-select">,</label>
		                        	<label class="control-label" for="type-select">每瓶</label>
		                        ...
		                        <div class="col-md-12">
			                        <table class="freightConfig">
			                        	<thead>
					                        ...
					                        <th class="hidden">首瓶（瓶）</th>
 					                        <th>首瓶首费（元）</th>
					                        <th class="hidden">续瓶（瓶）</th>
 					                        <th>两瓶及以上每瓶（元）</th>
					                        <th>操作 </th>
			                            </thead>
		                              	<tbody id="freightConfig">
				                           ...
				                           <tr> 
			                              	    ...
			                              	    <td class="hidden"><input type="text" class="form-control startNum" name="startNum" value="1">
			                              	    </td>
			                              	    ...
			                              	    <td class="hidden"><input type="text" class="form-control plusNum" name="plusNum" value="1">
			                              	    </td>
...
<div id="addEditTpl" style="height:260px;">
 ...
 <script src="${uiBase}/js/pages/freightConfig/freightConfig.js?v=${resourceVersion}"></script>
</html>
