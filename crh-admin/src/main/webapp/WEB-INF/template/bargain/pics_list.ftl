<label class="col-sm-2 control-label"><span class="requiredField">*</span>商品图片(微信端列表页):</label>
<div class="form-goods-pic">
	<div class="container">
	   <div class="title">
          <button type="button" class="btn btn-primary addNewPic hide"><i class="fa fa-plus"></i> 添加图片</button>
       </div>
...
<li class="goodspic-upload" id="upload_{{id}}">
    ...
    <div class="upload-btn" style="left:40px;">
