...
public class MessageModelDto implements Serializable {
    ...
    private String sms_C_KdProductRefundNotify;
    
    private String sms_C_KdActRefundNotify;
    ...
    public String getSms_C_KdProductRefundNotify() {
        return sms_C_KdProductRefundNotify;
    }
    public void setSms_C_KdProductRefundNotify(String sms_C_KdProductRefundNotify) {
        this.sms_C_KdProductRefundNotify = sms_C_KdProductRefundNotify;
    }
    public String getSms_C_KdActRefundNotify() {
        return sms_C_KdActRefundNotify;
    }
    public void setSms_C_KdActRefundNotify(String sms_C_KdActRefundNotify) {
        this.sms_C_KdActRefundNotify = sms_C_KdActRefundNotify;
    }
