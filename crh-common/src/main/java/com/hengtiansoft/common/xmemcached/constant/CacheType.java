 ...
 * Description:Defines the system cache type
 * The cache type defined here is consistent with 
 * the key of the cacheManager parameter configMap defined in the xmemcached-context.xml file
 * @author taochen
 *
 */
public class CacheType {
    ...
    /**
     * Variable name: THREAD_LOCAL  Description: only in the current ThreadLocal cache, will not be synchronized to Memcached, at the end of the request, the cache will be cleared
     */
